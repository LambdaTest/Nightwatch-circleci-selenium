...
With TestMu AI (Formerly LambdaTest), you can run NightWatch Selenium tests via CircleCI across real browsers and operating systems. This sample shows how to configure NightWatch to run on the TestMu AI cloud.
...
1. Clone this repository:
    ```bash
    git clone https://github.com/LambdaTest/Nightwatch-circleci-selenium
    cd Nightwatch-circleci-selenium
    ```
...
Set the `tunnel` capability to `true` in your NightWatch test configuration to route browser traffic through the TestMu AI tunnel to your locally hosted app.
